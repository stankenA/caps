...
export const developmentTitles = [
  "1. выберите тип сайта",
  "2. Если сайт уже есть - поделитесь",
  "3. Оставьте свои данные",
  "4. Оставьте комментарий (опционально)",
];
...
export const productionTitles = [
  "1. выберите желаемый продукт",
  "2. Оставьте свои данные",
  "3. Оставьте комментарий (опционально)",
];
export const productionArr = [
  "монтаж",
  "2D анимация",
  "саунд дизайн",
  "джингл",
...
export const aboutArr = [
  ...
  },
  {
    img: nikitaImg,
    title: "Никита",
    subtitle: "Директор по отстатию, OEC",
    txt: "“Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime cumque magnam porro dolorem, recusandae est? Necessitatibus”",
    audio: audioManagement,
  },
  {
